...
configure :build do
  ...
  activate :favicon_maker, :icons => {
    ...
    "_favicon_64x64.png" => [
      ...
      { icon: "favicon.ico", size: "64x64,32x32,24x24" },               # Used by IE, and also by some other browsers if we are not careful.
    ],

    "_favicon_32x32.png" => [
      { icon: "favicon-32x32.png" },                                    # For Safari on Mac OS.
      { icon: "favicon.ico", size: "32x32" },                           # Used by IE, and also by some other browsers if we are not careful.
